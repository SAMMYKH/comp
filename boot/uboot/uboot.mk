...
UBOOT_LOGO=$(call qstrip,$(BR2_TARGET_UBOOT_CUSTOM_LOGO))
...
ifneq ($(UBOOT_LOGO),)
define UBOOT_SET_CUSTOM_LOGO
	cp $(UBOOT_LOGO)/logo.bmp $(UBOOT_DIR)/tools/logos/logo.bmp
endef

UBOOT_POST_PATCH_HOOKS += UBOOT_SET_CUSTOM_LOGO
endif
