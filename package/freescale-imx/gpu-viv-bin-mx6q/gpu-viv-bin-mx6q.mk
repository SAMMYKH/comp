...
GPU_VIV_BIN_MX6Q_VERSION = 5.0.11.p4.1
ifeq ($(BR2_ARM_EABIHF),y)
GPU_VIV_BIN_MX6Q_SOURCE  = imx-gpu-viv-$(GPU_VIV_BIN_MX6Q_VERSION)-hfp.bin
else
GPU_VIV_BIN_MX6Q_SOURCE  = imx-gpu-viv-$(GPU_VIV_BIN_MX6Q_VERSION)-sfp.bin
endif
...
define GPU_VIV_BIN_MX6Q_EXTRACT_CMDS
	(cd $(BUILD_DIR); \
		...
		mv $(BUILD_DIR)/imx-gpu-viv-$(GPU_VIV_BIN_MX6Q_VERSION)-hfp/* $(@D); \
		rmdir $(BUILD_DIR)/imx-gpu-viv-$(GPU_VIV_BIN_MX6Q_VERSION)-hfp)
