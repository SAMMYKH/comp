...
GPSD_DEPENDENCIES = host-scons host-pkgconf host-python python
...
define GPSD_INSTALL_TARGET_CMDS
	(cd $(@D); \
		...
		$(SCONS) \
		$(GPSD_SCONS_OPTS) \
		install python_libdir=/usr/lib/python2.7/site-packages)
	python -m py_compile `find $(TARGET_DIR)/usr/lib/python2.7/site-packages/gps -name *.py`
