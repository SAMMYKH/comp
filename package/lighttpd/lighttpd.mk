...
define LIGHTTPD_INSTALL_CUSTOM_CONFIG
    mkdir -p $(TARGET_DIR)/etc/lighttpd
    $(INSTALL) -m 0644 -D $(BR2_PACKAGE_LIGHTTPD_CUSTOM_CONFIG_FILE) $(TARGET_DIR)/etc/lighttpd/lighttpd.conf
endef
...
ifeq ($(BR2_PACKAGE_LIGHTTPD_USE_CUSTOM_CONFIG),y)
LIGHTTPD_POST_INSTALL_TARGET_HOOKS += LIGHTTPD_INSTALL_CUSTOM_CONFIG
else
