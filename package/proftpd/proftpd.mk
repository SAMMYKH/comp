...
define PROFTPD_INSTALL_CUSTOM_CONFIG
    $(INSTALL) -m 0644 -D $(BR2_PACKAGE_PROFTPD_CUSTOM_CONFIG_FILE) $(TARGET_DIR)/etc/proftpd.conf
endef

define PROFTPD_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 0755 $(@D)/proftpd $(TARGET_DIR)/usr/sbin/proftpd
	$(if $(BR2_PACKAGE_PROFTPD_CUSTOM_CONFIG_FILE),
		$(call PROFTPD_INSTALL_CUSTOM_CONFIG))
