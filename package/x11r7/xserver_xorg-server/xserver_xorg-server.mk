...
XSERVER_XORG_SERVER_VERSION = 1.14.4
...
else ifeq ($(BR2_PACKAGE_XDRIVER_XF86_VIDEO_IMX_VIV),y)
XSERVER_XORG_SERVER_CONF_OPT += --enable-dri --enable-glx
XSERVER_XORG_SERVER_DEPENDENCIES += gpu-viv-bin-mx6q xproto_xf86driproto
else
